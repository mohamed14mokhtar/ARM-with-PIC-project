...
# 1 "./ECU_layer/chr_lcd/ecu_che_lcd_cfg.h" 1
# 12 "./ECU_layer/chr_lcd/ecu_chr_lcd.h" 2

# 1 "./ECU_layer/chr_lcd/../../MKAL_layer/gpio/pro_gpio.h" 1
# 13 "./ECU_layer/chr_lcd/../../MKAL_layer/gpio/pro_gpio.h"
# 1 "./ECU_layer/chr_lcd/../../MKAL_layer/gpio/../mkal_std_types.h" 1
# 11 "./ECU_layer/chr_lcd/../../MKAL_layer/gpio/../mkal_std_types.h"
# 1 "./ECU_layer/chr_lcd/../../MKAL_layer/gpio/../compiler.h" 1
# 12 "./ECU_layer/chr_lcd/../../MKAL_layer/gpio/../compiler.h"
...
# 12 "./ECU_layer/chr_lcd/../../MKAL_layer/gpio/../compiler.h" 2
# 11 "./ECU_layer/chr_lcd/../../MKAL_layer/gpio/../mkal_std_types.h" 2

# 1 "./ECU_layer/chr_lcd/../../MKAL_layer/gpio/../std_library.h" 1
# 15 "./ECU_layer/chr_lcd/../../MKAL_layer/gpio/../std_library.h"
...
# 15 "./ECU_layer/chr_lcd/../../MKAL_layer/gpio/../std_library.h" 2
# 12 "./ECU_layer/chr_lcd/../../MKAL_layer/gpio/../mkal_std_types.h" 2
...
# 13 "./ECU_layer/chr_lcd/../../MKAL_layer/gpio/pro_gpio.h" 2

# 1 "./ECU_layer/chr_lcd/../../MKAL_layer/gpio/../device_config.h" 1
# 14 "./ECU_layer/chr_lcd/../../MKAL_layer/gpio/pro_gpio.h" 2
# 36 "./ECU_layer/chr_lcd/../../MKAL_layer/gpio/pro_gpio.h"
typedef enum {
    GPIO_LOW=0,
    GPIO_HIGH
}logic_t;
...
# 1 "./ECU_layer/LED/ecu_led_con.h" 1
...
# 12 "./ECU_layer/button/ecu_button_cfg.h"
# 1 "./ECU_layer/button/ecu_button_cfg.h" 1
# 12 "./ECU_layer/button/ecu_button_cfg.h" 2
...
# 1 "./ECU_layer/relay/ecu_relay_cgf.h" 1
...
# 1 "./ECU_layer/7_segment/ecu_seg.h" 1
# 12 "./ECU_layer/7_segment/ecu_seg.h"
# 1 "./ECU_layer/7_segment/ecu_seg_cfg.h" 1
# 12 "./ECU_layer/7_segment/ecu_seg.h" 2
...
# 1 "./ECU_layer/matrix_keypad/ecu_keymap.h" 1
# 11 "./ECU_layer/matrix_keypad/ecu_keymap.h"
# 1 "./ECU_layer/matrix_keypad/ecu_keymap_cgf.h" 1
# 11 "./ECU_layer/matrix_keypad/ecu_keymap.h" 2
# 21 "./ECU_layer/matrix_keypad/ecu_keymap.h"
typedef struct {
    pin_config_t keymap_rows_pins[4];
    pin_config_t keymap_colums_pins[4];
}matrix_keypad_t;
...
# 1 "./MKAL_layer/Interrupt/mcal_external_interrupt.h" 1
# 12 "./MKAL_layer/Interrupt/mcal_external_interrupt.h"
# 1 "./MKAL_layer/Interrupt/mcal_interrupt_config.h" 1
# 14 "./MKAL_layer/Interrupt/mcal_interrupt_config.h"
# 1 "./MKAL_layer/Interrupt/mcal_interrupt_gen_cfg.h" 1
# 42 "./MKAL_layer/Interrupt/mcal_interrupt_gen_cfg.h"
typedef enum {
    INTERRUPT_LOW_PRIORITY = 0,
    INTERRUPT_HUGH_PRIORITY
}INTERRUPT_PRIORITY_t;
# 14 "./MKAL_layer/Interrupt/mcal_interrupt_config.h" 2
# 12 "./MKAL_layer/Interrupt/mcal_external_interrupt.h" 2
# 74 "./MKAL_layer/Interrupt/mcal_external_interrupt.h"
typedef enum {
...
# 1 "./MKAL_layer/Interrupt/mcal_interrupt_manager.h" 1
# 23 "./MKAL_layer/Interrupt/mcal_interrupt_manager.h"
void INT0_ISR (void);
void INT1_ISR (void);
void INT2_ISR (void);
...
# 1 "./MKAL_layer/EEPROM/hal_eeprom.h" 1
# 14 "./MKAL_layer/EEPROM/hal_eeprom.h"
# 1 "./MKAL_layer/EEPROM/../Interrupt/mcal_internal_interrupt.h" 1
# 14 "./MKAL_layer/EEPROM/hal_eeprom.h" 2
# 34 "./MKAL_layer/EEPROM/hal_eeprom.h"
...
# 1 "./MKAL_layer/ADC/hal_adc.h" 1
# 12 "./MKAL_layer/ADC/hal_adc.h"
# 1 "./MKAL_layer/ADC/hal_adc_cfg.h" 1
# 12 "./MKAL_layer/ADC/hal_adc.h" 2
# 66 "./MKAL_layer/ADC/hal_adc.h"
typedef enum {
    ADC_CHANNEL_AN0,
    ADC_CHANNEL_AN1,
    ADC_CHANNEL_AN2,
...
# 1 "./MKAL_layer/timer/hal_timer0.h" 1
# 11 "./MKAL_layer/timer/hal_timer0.h"
# 1 "./MKAL_layer/timer/hal_timer0_cfg.h" 1
# 11 "./MKAL_layer/timer/hal_timer0.h" 2
# 47 "./MKAL_layer/timer/hal_timer0.h"
typedef enum {
...
# 1 "./MKAL_layer/timer1/hal_timer1.h" 1
# 12 "./MKAL_layer/timer1/hal_timer1.h"
# 1 "./MKAL_layer/timer1/hal_timer1_cfg.h" 1
# 12 "./MKAL_layer/timer1/hal_timer1.h" 2
# 65 "./MKAL_layer/timer1/hal_timer1.h"
typedef struct {
...
# 1 "./MKAL_layer/timer2/hal_timer2.h" 1
# 12 "./MKAL_layer/timer2/hal_timer2.h"
# 1 "./MKAL_layer/timer2/hal_timer2_cfg.h" 1
# 12 "./MKAL_layer/timer2/hal_timer2.h" 2
# 28 "./MKAL_layer/timer2/hal_timer2.h"
typedef enum {
    Postscale_div_by_1,
    Postscale_div_by_2,
    Postscale_div_by_3,
...
# 1 "./MKAL_layer/timer3/hal_timer3.h" 1
# 12 "./MKAL_layer/timer3/hal_timer3.h"
# 1 "./MKAL_layer/timer3/hal_timer3_cfg.h" 1
# 12 "./MKAL_layer/timer3/hal_timer3.h" 2
# 44 "./MKAL_layer/timer3/hal_timer3.h"
typedef enum {
...
# 1 "./MKAL_layer/CCP1/hal_ccp1.h" 1
# 12 "./MKAL_layer/CCP1/hal_ccp1.h"
# 1 "./MKAL_layer/CCP1/hal_ccp1_cfg.h" 1
# 12 "./MKAL_layer/CCP1/hal_ccp1.h" 2
# 64 "./MKAL_layer/CCP1/hal_ccp1.h"
typedef union{
    struct{
        uint8 ccpr1_l;
        uint8 ccpr1_h;
...
# 1 "./MKAL_layer/CCP2/hal_ccp2.h" 1
# 12 "./MKAL_layer/CCP2/hal_ccp2.h"
# 1 "./MKAL_layer/CCP2/hal_ccp2_cfg.h" 1
# 12 "./MKAL_layer/CCP2/hal_ccp2.h" 2
# 64 "./MKAL_layer/CCP2/hal_ccp2.h"
typedef union{
    struct{
        uint8 ccpr2_l;
        uint8 ccpr2_h;
...
# 1 "./MKAL_layer/USART/hal_usart.h" 1
# 12 "./MKAL_layer/USART/hal_usart.h"
# 1 "./MKAL_layer/USART/hal_usart_cfg.h" 1
# 12 "./MKAL_layer/USART/hal_usart.h" 2
# 61 "./MKAL_layer/USART/hal_usart.h"
typedef enum {
...
# 1 "./MKAL_layer/I2C/hal_i2c.h" 1
# 11 "./MKAL_layer/I2C/hal_i2c.h"
# 1 "./MKAL_layer/I2C/hal_i2c_cfg.h" 1
# 11 "./MKAL_layer/I2C/hal_i2c.h" 2
# 72 "./MKAL_layer/I2C/hal_i2c.h"
typedef struct{
 uint8 i2c_mode_cfg;
...
void MSSP_I2C_Master_call_slave(const mssp_i2c_t *i2c_obj, uint8 address,uint8 data, uint8 *_ack);
# 27 "./main.h" 2

# 1 "./ECU_layer/24c02c/ecu_24c02c.h" 1
# 13 "./ECU_layer/24c02c/ecu_24c02c.h"
...
# 1 "./ECU_layer/TC74/hal_tc74.h" 1
# 22 "./ECU_layer/TC74/hal_tc74.h"
void tc74_read_value(const mssp_i2c_t *i2c_obj, uint8 i2c_data_1, uint8 i2c_data_2,uint8 *ret_data,uint8 *_ack);
# 29 "./main.h" 2

# 1 "./ECU_layer/DS1307/hal_ds1307.h" 1
# 15 "./ECU_layer/DS1307/hal_ds1307.h"
typedef struct {
    uint8 seconds;
    uint8 minutes;
    uint8 hours;
...
usart_t usart_1 ={
   .baudrate= 9600,.buadrate_gen=BAUDRATE_ASY_8BIT_LOW_SPEED ,.usart_tx.usart_tx_enable=1,
   .usart_tx.usart_tx_interrupt_enable=1,
   .usart_tx.usart_tx_9bits_enable=0,.usart_rx.usart_rx_enable=1,
   .usart_rx.usart_rx_interrupt_enable=1,
   .usart_rx.usart_rx_9bits_enable=0,.USART_RX_INTERRUPT_HANDLER=interrupt_usart_rx
};
ADC_conf_t ADC_ = {.ADC_CHANNAL_SELECT=ADC_CHANNEL_AN3,.ADC_interruptHandler=((void*)0),.Acquisition_time=ADC_12_TAD,
.Conversion_Clock=FOSC_div_16,.result_format=1,.voltage_ref=0};
ADC_conf_t ADC_2 = {.ADC_CHANNAL_SELECT=ADC_CHANNEL_AN0,.ADC_interruptHandler=((void*)0),.Acquisition_time=ADC_12_TAD,
.Conversion_Clock=FOSC_div_16,.result_format=1,.voltage_ref=0};

pin_config_t LED_ROOM_1 = {.port=PORTC_INDEX,.pin=pin0,.logic=GPIO_LOW,.direction=GPIO_OUTPUT};

mssp_i2c_t mssp_i2c = {.i2c_clock=100000,.i2c_cfg.i2c_SMBus_control=0,
.i2c_cfg.i2c_general_call=0,.i2c_cfg.i2c_master_rec_mode=0,
.i2c_cfg.i2c_mode=1,.i2c_cfg.i2c_mode_cfg=0x08U,
.I2C_DefaultInterruptHandler=((void*)0),.I2C_Report_Receive_Overflow=((void*)0),.I2C_Report_Write_Collision=((void*)0)};
...
ccp2_t ccp2_={.CCP2_handler = ((void*)0) ,.ccp2_mode=0x0E,.ccp2_pwm_frequence=10000,.pin_config.port=PORTC_INDEX,
.pin_config.pin=pin2,.pin_config.direction=GPIO_OUTPUT,.ccp2_timer2_postscaler_cfg=1,
.ccp2_timer2_prescaler_cfg=1,.ccp2_mode_variant=0x0E};
ccp1_t ccp1_={.CCP1_handler = ((void*)0) ,.ccp1_mode=0x0E,.pwm_frequence=10000,.pin_config.port=PORTC_INDEX,
.pin_config.pin=pin2,.pin_config.direction=GPIO_OUTPUT,.timer2_postscaler_cfg=1,
.timer2_prescaler_cfg=1,.ccp1_mode_variant=0x0E};

Timer2_t Timer2 ={.Timer2_handler=((void*)0),
...
Std_ReturnType ret ;
uint8 dataSendUART[2] ={0} ;
adc_result_t ADC_VALUE;
volatile uint32 ADC_VALUE_2;
volatile uint8 ADC_VALUE_convert;
volatile uint8 dataReceiveUART;
volatile uint8 tc74;
uint8 i2c_ack;
volatile uint8 ds13_data[6];
uint8 mes[5];
uint8 ds13_data_decimal[6];
uint8 chick = 0 ;
int main() {
    ...
    while(1){
        ...
        ret = ADC_get_conversion_blocking(&ADC_,ADC_CHANNEL_AN3,&ADC_VALUE);
        ADC_VALUE_convert = ADC_VALUE - 854;
        dataSendUART[0]= ADC_VALUE_convert;
        ...
        ADC_VALUE_2 = ((ADC_VALUE_2*100)/1022);
            ...
            (CCP2CONbits.CCP2M =0x0E);


        tc74_read_value(&mssp_i2c,(uint8)0X9E,(uint8)0x00,&tc74,&i2c_ack);
        dataSendUART[1]= tc74;
        sprintf(mes , "%i",tc74);
        ...
        while(tc74 >= 40){
            ...
            lcd_4bit_send_command(&lcd_4bit,0X01);
        ...
        ds1307_read_values(&mssp_i2c,0xD0,ds13_data,&i2c_ack);
        for(uint8 i =0 ; i<6 ;i++){
